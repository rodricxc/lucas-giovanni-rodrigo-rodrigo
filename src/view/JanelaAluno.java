 ...
 * @author rodricxc
 */
public class JanelaAluno extends javax.swing.JDialog {

    /**
     * Creates new form JanelaAluno
     */
    public JanelaAluno(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    JanelaAluno(JanelaPrincipal aThis, boolean b, Aluno aluno) {
        this(aThis,b);
        this.setAluno(aluno);
        this.jTextField1.setText(aluno.getNome());
        this.jTextField2.setText(aluno.getCpf());
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(consultarBotao, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void consultarBotaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarBotaoActionPerformed
       ConsultaAluno cad = new ConsultaAluno(null, true,aluno);
        cad.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JanelaAluno dialog = new JanelaAluno(new javax.swing.JFrame(), true);
